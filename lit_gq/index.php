...
<header>
	...
	<table class="nav_me nav" id="fix_nav_uinfo">
		<tr>
			<td><a class="pub"><i class="icon-pictures"></i></a></td>
  ...
  <section id="userInfo">
	<!-- 个人信息 -->
	  <div class="info">
		...
		<span>
		  <div class="uname"><?php echo $uname?></div>
		  <div class="usrname">登录名：<span><?php echo $logname?></span>
		  </div>
		</span>
		<table class="nav_me" id="nav_uinfo">
			<tr>
				<td><a class="pub">直播<i class="icon-pictures"></i></a></td>
...
<?php
  ...
  <section class="fill_activity" id="fillActivity">
	<div class="head">
	  <span class="icon-undo2 back-l" id="leaveEdit"></span>图文编辑
